...
# the different plugins, in this case SQL Drivers,
# that PyQt is trying to load. Useful if you want
# to use plugins other than SQLite and are getting errors

# os.environ['QT_DEBUG_PLUGINS'] = "1"
class CreateDatabaseObjects:
    def __init__(self, config_file):
        self.config_options = DbConfig(config_file)
    ...
    def insert_into_tables(self):
        ...
        customers = [
            ["James", "Smith", 'NULL'], ["Mary", "Johnson", 'NULL'], ["John", "Williams", 'NULL'],
            ["Patricia", "Brown", '(716) 472-1234'], ["Lijing", "Ye", 'NULL'], ["Andrea", "Cotman", 'NULL'],
            ["Aaron", "Rountree", 'NULL'], ["Malik", "Ranger", 'NULL'], ["Helen", "Rodriguez", 'NULL'],
            ["Linda", "Martinez", 'NULL'], ["William", "Hernandez", '(757) 408-1121'],
            ["Elizabeth", "Lopez", '(804) 543-9876'], ["David", "Gonzalez", 'NULL'],
            ["Barbara", "Wilson", 'NULL'],
            ["Richard", "Anderson", 'NULL'], ["Susan", "Thomas", '(213) 854-7771'],
            ["Joseph", "Taylor", '(609) 341-9801'], ["Jessica", "Moore", '(707) 121-0909'],
            ["Thomas", "Jackson", 'NULL'], ["Sarah", "Martin", 'NULL'], ["Ryan", "Lee", 'NULL'],
            ["Cynthia", "Perez", '(754) 908-5432'], ["Jacob", "Thompson", '(763) 765-1023'],
            ["Kathleen", "White", 'NULL'], ["Gary", "Harris", 'NULL'], ["Amy", "Sanchez", '(213) 198-4510'],
            ["Nicholas", "Clark", 'NULL'], ["Shirley", "Ramirez", '(231) 480-1567'], ["Eric", "Lewis", 'NULL'],
            ["Angela", "Miller", 'NULL']
        ]

        stores = [
            ['Boston Fish Supplies', '(617) 987-6543', 'MA'], ['Miami Fish Supplies', '(786) 123-4567', 'FL']
        ]

        orders = [
            [2, '2020-01-04', 1, 1], [18, '2020-01-05', 2, 1], [30, '2020-01-08', 1, 2],
            [6, '2020-01-10', 3, 2], [21, '2020-01-11', 1, 2], [19, '2020-01-11', 3, 1], [27, '2020-01-12', 3, 1],
            [1, '2020-01-14', 2, 2], [5, '2020-01-15', 1, 2], [29, '2020-01-15', 2, 1], [28, '2020-01-16', 1, 2],
            [9, '2020-01-17', 1, 1], [26, '2020-01-17', 2, 2], [10, '2020-01-18', 3, 1], [3, '2020-01-18', 3, 2],
            [11, '2020-01-19', 4, 2], [14, '2020-01-20', 1, 1], [20, '2020-01-20', 2, 1], [8, '2020-01-20', 3, 1],
            [12, '2020-01-20', 2, 2], [15, '2020-01-21', 4, 1], [4, '2020-01-23', 1, 1], [22, '2020-01-24', 3, 2],
            [13, '2020-01-26', 2, 2], [7, '2020-01-26', 1, 2], [16, '2020-01-27', 3, 2], [17, '2020-01-29', 2, 1],
            [23, '2020-01-30', 3, 1], [24, '2020-02-01', 1, 2], [25, '2020-02-03', 2, 2]
        ]
        ...
        order_products = [
            [1, 2, 1, 24.99], [2, 14, 2, 159.99], [3, 11, 1, 399.99], [4, 1, 8, 27.99], [5, 1, 2, 12.99],
            [6, 4, 4, 13.99], [7, 1, 1, 27.99], [8, 8, 2, 79.99], [9, 8, 1, 79.99], [10, 13, 1, 249.99],
            [11, 1, 1, 27.99], [12, 11, 3, 399.99], [13, 12, 2, 199.99], [14, 7, 1, 169.99],
            [15, 3, 3, 24.99], [16, 10, 1, 129.99], [17, 13, 1, 249.99], [18, 6, 2, 119.95],
            [19, 5, 1, 59.99], [20, 8, 1, 79.99], [21, 6, 1, 119.95], [22, 5, 2, 59.99],
            [23, 14, 1, 159.99], [24, 2, 2, 12.99], [25, 1, 1, 27.99], [26, 10, 1, 129.99],
            [27, 2, 3, 12.99], [28, 9, 1, 69.99], [29, 13, 1, 249.99], [30, 6, 1, 119.95]
        ]
...
if __name__ == "__main__":
    ...
    db_obj = CreateDatabaseObjects('db_settings')
    sys.exit(app.exec())